...
import NutezienListingBlockTemplate from '../components/manage/Blocks/Listing/NutezienTemplate';
  ...
  listing: {
    ...
    variations: [
      ...
      },
      {
        id: 'nutezien',
        title: 'Nutezien',
        template: NutezienListingBlockTemplate,
      },
    ],
